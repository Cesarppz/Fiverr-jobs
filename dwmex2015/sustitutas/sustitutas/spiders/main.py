...
class Webscrape(scrapy.Spider):
    ...
    def get_links_by_scralling(self,url,xpath_expresion, attribute='href',executable_path='/home/cesar/Documents/job/web_scraping/javier/agenda/driver/geckodriver'):
